                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                ...
                                                <span class="text-inverse">Li e aceito os <a href="#">Termos e Condições de Uso.</a></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button class="btn btn-inverse btn-md btn-block waves-effect text-center m-b-20" id="registrar">Registrar</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="<?php echo base_url();?>"><b style="font-size: 15px; font-weight: bold; color: #37474f;">Retornar ao Site</b></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
