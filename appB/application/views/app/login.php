                    ...
                    <form class="md-float-material form-material" id="formLogin">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <p class="text-inverse text-left">Não tem uma conta?<a href="<?php echo base_url();?>app/cadastro"> <b style="font-size: 15px; font-weight: bold; color: #37474f;">Registre aqui </b></a>gratuitamente!</p>
                            </div>
                        </div>
                    </form>
                        <!-- end of form -->
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data.tip == 1){
                            ...
                            swal("Parabéns!", 'Redirecionando...', "success");
